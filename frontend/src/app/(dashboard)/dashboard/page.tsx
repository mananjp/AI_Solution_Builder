      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        {engineOnline !== null && (
          <div className="flex items-center gap-2">
            <span className="text-[10px] uppercase tracking-widest font-semibold text-[var(--text-3)]">OpenCode sidecar</span>
            <button
              type="button"
              onClick={runDiagnose}
              ...
              {engineOnline ? (engineModel ? `Online · ${engineModel}` : 'Online') : 'Fallback Mode'}
            </button>
          </div>
        )}
      </div>
